...
import { Landmark, Wine, Leaf } from 'lucide-react'
import restaurant from '../data/restaurant.json'

function AboutSection() {
  const features = [
    { icon: Landmark, title: 'Heritage Estate', desc: 'Crafting wines since 1685' },
    { icon: Wine, title: 'Vin de Constance', desc: 'Napoleon\'s favourite wine' },
    { icon: Leaf, title: 'Conservation Champion', desc: 'WWF certified sustainability' },
  ]
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl hidden md:block">
                <p className="font-display text-3xl font-bold text-black">340+</p>
                <p className="text-black/70 text-sm">Years of Winemaking</p>
              </div>
            </div>
          </motion.div>
