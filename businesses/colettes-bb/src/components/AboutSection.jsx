...
import { Home, Coffee, MapPin } from 'lucide-react'
import restaurant from '../data/restaurant.json'

function AboutSection() {
  const features = [
    { icon: Home, title: 'Home-from-Home', desc: 'Warm, personal hospitality' },
    { icon: Coffee, title: 'Hearty Breakfast', desc: 'A great start to your day' },
    { icon: MapPin, title: 'Perfectly Central', desc: 'Minutes from everywhere' },
  ]
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl hidden md:block">
                <p className="font-display text-3xl font-bold text-black">3★</p>
                <p className="text-black/70 text-sm">Graded B&B</p>
              </div>
            </div>
          </motion.div>
