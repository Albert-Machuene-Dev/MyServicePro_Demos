...
function AboutSection() {
  const features = [
    { icon: Heart, title: 'Family Owned', desc: 'Owner-run since 2007' },
    { icon: Award, title: 'SATSA Accredited', desc: 'Trusted & certified' },
    { icon: Route, title: 'Custom Itineraries', desc: 'Tailored to you' },
  ]
          ...
          >
            <div className="relative">
              <img
                ...
                alt="Wow Travel & Tours adventure"
